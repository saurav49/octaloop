...
const Signup = () => {
  ...
  return (
    <div className="w-[80%] mx-auto mt-5 sm:mt-10 sm:mr-32 sm:w-[450px] bg-[#ffffff] p-10 flex flex-col items-start rounded-lg">
      <p className="text-sm text-[#97999b] uppercase">type something here</p>
      <h2 className="text-5xl font-semibold text-[#000000]">
        Sign up to Binamite
      </h2>
      <p className="text-lg text-[#97999b] ">
        Already a member?
      ...
      <div className="flex flex-col items-start space-y-2">
        ...
        <div className="relative sm:w-[85%] flex items-center">
          <input
            type="password"
            name="password"
        ...
        <p className="text-xs text-[#97999b] mt-2">
